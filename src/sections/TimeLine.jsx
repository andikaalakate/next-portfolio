...
const TimeLine = () => {
    return (
        <>
            <section id="timeline" className="px-1 w-full">
                <div
                    className="container shadow-md py-16"
                    data-aos="fade-up"
                    data-aos-anchor-placement="top-center"
                >
                    <div className="max-w-xl mx-auto text-center pt-10 pb-8">
                    ...
                    <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
                        <li data-aos="fade-up"
                            ...
                            <div className="border-2 border-black bg-primary rounded-md p-4 timeline-start md:text-end mb-10">
                                <time className="font-mono italic">1984</time>
                                <div className="text-lg text-white">First Macintosh computer</div>
                        ...
                        <li data-aos="fade-up"
                            ...
                            <div className="border-2 border-black bg-primary rounded-md p-4 timeline-end mb-10">
                                <time className="font-mono italic">1998</time>
                                <div className="text-lg text-white">iMac</div>
                                <p className="text-slate-300">
                        ...
                        <li data-aos="fade-up"
                            ...
                            <div className="border-2 border-black bg-primary rounded-md p-4 timeline-start md:text-end mb-10">
                                ...
                                <div className="text-lg text-white">iPod</div>
                                <p className="text-slate-300">
                        ...
                        <li data-aos="fade-up"
                            ...
                            <div className="border-2 border-black bg-primary rounded-md p-4 timeline-end mb-10">
                                ...
                                <div className="text-lg text-white">iPhone</div>
                                <p className="text-slate-300">
                        ...
                        <li data-aos="fade-up"
                            ...
                            <div className="border-2 border-black bg-primary rounded-md p-4 timeline-start md:text-end mb-10">
                                ...
                                <div className="text-lg text-white">Apple Watch</div>
                                <p className="text-slate-300">
